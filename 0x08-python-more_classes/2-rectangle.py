...
This module is based on the `1-rectangle` module. \
    As an improvement, it implements the area and \
    perimeter methods of the Rectangle.
"""
...
class Rectangle:
    ...
    def perimeter(self):
        ...
        Return:
            int: the perimeter or zero if either width of height is 0.
        """
